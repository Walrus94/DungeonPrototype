...
from config.settings import KAFKA_BOOTSTRAP_SERVER, KAFKA_TOPIC_BALANCES, KAFKA_TOPIC_ITEM_NAMING
...
kafka_consumer.subscribe([KAFKA_TOPIC_BALANCES, KAFKA_TOPIC_ITEM_NAMING])
...
def consume_messages():
    ...
    while True:
        ...
        elif topic == KAFKA_TOPIC_BALANCES:
